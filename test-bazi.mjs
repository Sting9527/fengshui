...
console.log('【命局信息】');
console.log('旬空:', lunar.getXunKong());
console.log('胎元:', lunar.getTaiYuan());
console.log('命宫:', lunar.getMingGong());
console.log('');

console.log('【天干关系】');
console.log('合:', lunar.getTianGanHe() || '无');
console.log('冲:', lunar.getTianGanChong() || '无');
console.log('');

console.log('【地支关系】');
console.log('合:', lunar.getDiZhiHe() || '无');
console.log('冲:', lunar.getDiZhiChong() || '无');
console.log('刑:', lunar.getDiZhiXing() || '无');
console.log('害:', lunar.getDiZhiHai() || '无');
console.log('');
